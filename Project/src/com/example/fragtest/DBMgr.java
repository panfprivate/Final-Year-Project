...
public class DBMgr {
    ...
    public static final String TASK_CHECKED = "check";
    ...
    private static final String TASKDB_CREATE =
        ...
        + "tasktitle text not null, taskbody text not null);";//, check text not null
    ...
    public Cursor fetchTask(long rowId) throws SQLException {
        ...
        Cursor mCursor =
            ...
            mDb.query(true, DATABASE_TASKTABLE, new String[] {KEY_ROWID,
                    TASK_TITLE, TASK_BODY}, KEY_ROWID + "=" + rowId, null,
                    null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
